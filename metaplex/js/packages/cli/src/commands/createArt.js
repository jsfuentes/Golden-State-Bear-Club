    ...
    return function makeCreateImage(canvas, context) {
        return function createImage(image) {
            return __awaiter(this, void 0, void 0, function () {
                var start, ID, _i, order_1, cur, imageLocation, loadedImage, buffer, optimizedImage, end, duration;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            cur = order_1[_i];
                            imageLocation = "".concat(metadata_1.TRAITS_DIRECTORY, "/").concat(cur, "/").concat(image[cur]);
                        ...
                        case 5:
                            ...
                            return [4 /*yield*/, (0, promises_1.writeFile)("".concat(metadata_1.ASSETS_DIRECTORY, "/").concat(ID, ".png"), optimizedImage)];
                        case 6:
                            _a.sent();
                            end = Date.now();
                            loglevel_1["default"].info("Placed ".concat(ID, ".png into ").concat(metadata_1.ASSETS_DIRECTORY, "."));
                            duration = end - start;
                            loglevel_1["default"].info('Image generated in:', "".concat(duration, "ms."));
                            return [2 /*return*/];
                    }
                });
            });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    loglevel_1["default"].info("Instanciating ".concat(workerNb, " workers to generate ").concat(imagesNb, " images."));
                ...
                case 2:
                    ...
                    duration = end - start;
                    loglevel_1["default"].info("Generated ".concat(imagesNb, " images in"), "".concat(duration / 1000, "s."));
                    return [2 /*return*/];
            }
        });
    });
