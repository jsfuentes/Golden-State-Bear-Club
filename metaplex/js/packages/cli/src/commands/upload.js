...
function uploadV2(_a) {
  ...
  var files = _a.files,
    ...
    env = _a.env,
    totalNFTs = _a.totalNFTs,
    storage = _a.storage,
    retainAuthority = _a.retainAuthority,
    mutable = _a.mutable,
    ipfsCredentials = _a.ipfsCredentials,
    awsS3Bucket = _a.awsS3Bucket,
    batchSize = _a.batchSize,
    price = _a.price,
    treasuryWallet = _a.treasuryWallet,
    splToken = _a.splToken,
    gatekeeper = _a.gatekeeper,
    goLiveDate = _a.goLiveDate,
    endSettings = _a.endSettings,
    whitelistMintSettings = _a.whitelistMintSettings,
    hiddenSettings = _a.hiddenSettings,
    uuid = _a.uuid,
    walletKeyPair = _a.walletKeyPair,
    anchorProgram = _a.anchorProgram,
    arweaveJwk = _a.arweaveJwk;
    ...
    return __generator(this, function (_k) {
      switch (_k.label) {
        case 0:
          ...
          dedupedAssetKeys = getAssetKeysNeedingUpload(
            cacheContent.items,
            files,
          );
          SIZE = dedupedAssetKeys.length;
          dirname = path_1.dirname(files[0]);
          ...
          console.log('JORGES DOOMED2', firstAssetKey, dedupedAssetKeys);
          firstAssetManifest = getAssetManifest(
            dirname,
        ...
        case 1:
          ...
          if (
            !((_c =
              (_b = firstAssetManifest.properties) === null || _b === void 0
                ? void 0
                : _b.creators) === null || _c === void 0
              ? void 0
              : _c.every(function (creator) {
          ...
          return [
            4 /*yield*/,
            (0, accounts_1.createCandyMachineV2)(
              anchorProgram,
              walletKeyPair,
              treasuryWallet,
              splToken,
              {
                ...
                creators: firstAssetManifest.properties.creators.map(function (
                  creator,
                ) {
                  return {
        ...
        case 2:
          ...
          loglevel_1['default'].info(
            'initialized config for a candy machine with publickey: '.concat(
        ...
        case 3:
          ...
          loglevel_1['default'].error(
            'Error deploying config to Solana network.',
            exx_1,
          );
          throw exx_1;
        case 4:
        ...
        case 5:
          loglevel_1['default'].info(
            'config for a candy machine with publickey: '.concat(
        ...
        case 8:
          ...
          _k.label = 9;
        case 9:
          arweaveBundleUploadGenerator = _d.apply(
            void 0,
            _e.concat([
              _f,
              storage === storage_type_1.StorageType.ArweaveSol
        ...
        case 11:
          (_j = _k.sent()),
            (cacheKeys = _j.cacheKeys),
            (arweavePathManifestLinks = _j.arweavePathManifestLinks),
            (updatedManifests = _j.updatedManifests);
          ...
          return [
            ...
            Promise.all(
              (0, various_1.chunks)(
                ...
                batchSize || 50,
              ).map(function (allIndexesInSlice) {
                  ...
                  return __generator(this, function (_e) {
                    switch (_e.label) {
                      case 0:
                        ...
                        _e.label = 1;
                      case 1:
                        if (!(i < allIndexesInSlice.length))
                          return [3 /*break*/, 12];
                        assetKey = dedupedAssetKeys[allIndexesInSlice[i]];
                        image = path_1.join(
                          dirname,
                          ''.concat(assetKey.index).concat(assetKey.mediaExt),
                        );
                        ...
                        if (
                          allIndexesInSlice[i] >= lastPrinted_1 + tick_1 ||
                          allIndexesInSlice[i] === 0
                        ) {
                          lastPrinted_1 = allIndexesInSlice[i];
                          loglevel_1['default'].info(
                            'Processing asset: '.concat(allIndexesInSlice[i]),
                          );
                        }
                      ...
                      case 10:
                        err_1 = _e.sent();
                        loglevel_1['default'].error(
                          'Error uploading file '.concat(assetKey),
                          err_1,
                        );
                        i--;
                        return [3 /*break*/, 11];
                  ...
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      case 0:
                        ...
                        _a.label = 1;
                      case 1:
                        if (!(offset < allIndexesInSlice.length))
                          return [3 /*break*/, 6];
                        ...
                        onChain = indexes.filter(function (i) {
                          ...
                          var index = keys[i];
                          return (
                            ((_a = cacheContent.items[index]) === null ||
                            _a === void 0
                              ? void 0
                              : _a.onChain) || false
                          );
                        ...
                        loglevel_1['default'].info(
                          'Writing indices '
                            .concat(ind, '-')
                            .concat(keys[indexes[indexes.length - 1]]),
                        );
                        _a.label = 2;
                      case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [
                          4 /*yield*/,
                          anchorProgram.rpc.addConfigLines(
                            ind,
                      ...
                      case 3:
                        ...
                        indexes.forEach(function (i) {
                          cacheContent.items[keys[i]] = __assign(
                            __assign({}, cacheContent.items[keys[i]]),
                            { onChain: true, verifyRun: false },
                          );
                        });
                        (0, cache_1.saveCache)(cacheName, env, cacheContent);
                        return [3 /*break*/, 5];
...
function getAssetKeysNeedingUpload(items, files) {
  var all = __spreadArray(
    [],
    new Set(
      __spreadArray(
        __spreadArray([], Object.keys(items), true),
        files.map(function (filePath) {
          console.log('F', path_1.basename(filePath));
  ...
  var keyMap = {};
  console.log('JORGE DDDOOOM', all, files);
  return files
    ...
    .filter(function (k) {
      return !k.includes('.json');
    })
    .reduce(function (acc, assetKey) {
      var _a;
      var ext = path_1.extname(assetKey);
      var key = path_1.basename(assetKey, ext);
      if (
        !((_a = items[key]) === null || _a === void 0 ? void 0 : _a.link) &&
        !keyMap[key]
      ) {
        keyMap[key] = true;
...
function getAssetManifest(dirname, assetKey) {
  ...
  var assetIndex = assetKey.includes('.json')
    ...
    : assetKey;
  var manifestPath = path_1.join(dirname, ''.concat(assetIndex, '.json'));
  var manifest = JSON.parse(fs_1.readFileSync(manifestPath).toString());
  manifest.image = manifest.image.replace('image', assetIndex);
  if (
    ((_b =
      (_a = manifest.properties) === null || _a === void 0
        ? void 0
    ...
    manifest.properties.files[0].uri =
      (_d =
        (_c = manifest.properties.files[0]) === null || _c === void 0
          ? void 0
          : _c.uri) === null || _d === void 0
        ? void 0
        : _d.replace('image', assetIndex);
  }
  return manifest;
}
/**
...
function writeIndices(_a) {
  var anchorProgram = _a.anchorProgram,
    cache = _a.cache,
    cacheName = _a.cacheName,
    env = _a.env,
    config = _a.config,
                    ...
                    switch (_a.label) {
                      ...
                      case 1:
                        ...
                        onChain = indexes.filter(function (i) {
                          ...
                          var index = keys[i];
                          return (
                            ((_a = cache.items[index]) === null || _a === void 0
                              ? void 0
                              : _a.onChain) || false
                          );
                        });
                      ...
                      case 3:
                        _a.sent();
                        indexes.forEach(function (i) {
                          cache.items[keys[i]] = __assign(
                            __assign({}, cache.items[keys[i]]),
                            { onChain: true },
                          );
                        });
    ...
    return __generator(this, function (_j) {
      switch (_j.label) {
        case 0:
          ...
          if (
            !((_b = cache.program) === null || _b === void 0
              ? void 0
              : _b.config)
          ) {
            loglevel_1['default'].error(
          ...
          return [
            4 /*yield*/,
            (0, accounts_1.loadCandyProgram)(walletKeyPair, env, rpcUrl),
          ];
        case 1:
          ...
          _d = [storage, dirname, dedupedAssetKeys];
          if (!(storage === storage_type_1.StorageType.ArweaveBundle))
            return [3 /*break*/, 3];
          _g = (_f = JSON).parse;
          return [4 /*yield*/, (0, promises_1.readFile)(arweaveJwk)];
        ...
        case 3:
          ...
          _j.label = 4;
        case 4:
          arweaveBundleUploadGenerator = _c.apply(
            void 0,
            _d.concat([
              _e,
              storage === storage_type_1.StorageType.ArweaveSol
        ...
        case 6:
          (_h = _j.sent()),
            (cacheKeys = _h.cacheKeys),
            (arweavePathManifestLinks = _h.arweavePathManifestLinks),
            (updatedManifests = _h.updatedManifests);
          updateCacheAfterUpload(
            cache,
            cacheKeys,
            arweavePathManifestLinks,
                    ...
                    switch (_e.label) {
                      ...
                      case 1:
                        ...
                        if (i >= lastPrinted_2 + tick_2 || i === 0) {
                          lastPrinted_2 = i;
                          loglevel_1['default'].info(
                            'Processing asset: '.concat(assetKey),
                          );
                        }
                        (link = void 0), (imageLink = void 0);
                        _e.label = 2;
