...
function upload(data, manifest, index) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    loglevel_1["default"].debug("trying to upload image ".concat(index, ": ").concat(manifest.name));
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    storageCost = _c.sent();
                    loglevel_1["default"].debug("lamport cost to store ".concat(image, ": ").concat(storageCost));
                    instructions = [
                ...
                case 3:
                    tx = _c.sent();
                    loglevel_1["default"].debug("solana transaction (".concat(env, ") for arweave payment:"), tx);
