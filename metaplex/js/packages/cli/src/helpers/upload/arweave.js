...
function fetchAssetCostToStore(fileSizes) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, (0, arweave_cost_1.calculate)(fileSizes)];
        case 1:
          result = _a.sent();
      ...
      switch (_a.label) {
        case 0:
          loglevel_1['default'].debug(
            'trying to upload image '.concat(index, ': ').concat(manifest.name),
          );
          return [
            4 /*yield*/,
            (0, node_fetch_1['default'])(ARWEAVE_UPLOAD_ENDPOINT, {
              method: 'POST',
              // @ts-ignore
              body: data,
            }),
...
function estimateManifestSize(filenames) {
  ...
  for (var _i = 0, filenames_1 = filenames; _i < filenames_1.length; _i++) {
    ...
    paths[name_1] = {
      ...
      ext: path_1.extname(name_1).replace('.', ''),
    };
  }
  var manifest = {
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 2:
          storageCost = _c.sent();
          loglevel_1['default'].debug(
            'lamport cost to store '.concat(image, ': ').concat(storageCost),
          );
          instructions = [
          ...
          return [
            4 /*yield*/,
            (0, transactions_1.sendTransactionWithRetryWithKeypair)(
        ...
        case 3:
          tx = _c.sent();
          loglevel_1['default'].debug(
            'solana transaction ('.concat(env, ') for arweave payment:'),
            tx,
          );
          data = new form_data_1();
          data.append('transaction', tx['txid']);
          data.append('env', env);
          data.append('file[]', fs_1.createReadStream(image), {
        ...
        case 4:
          result = _c.sent();
          metadataFile =
            (_a = result.messages) === null || _a === void 0
              ? void 0
              : _a.find(function (m) {
                  return m.filename === 'manifest.json';
                });
          imageFile =
            (_b = result.messages) === null || _b === void 0
              ? void 0
              : _b.find(function (m) {
                  return m.filename === ''.concat(index).concat(imageExt);
                });
          if (
            metadataFile === null || metadataFile === void 0
              ? void 0
              : metadataFile.transactionId
          ) {
            link = 'https://arweave.net/'.concat(metadataFile.transactionId);
            imageLink = 'https://arweave.net/'
              .concat(imageFile.transactionId, '?ext=')
              .concat(imageExt.replace('.', ''));
            loglevel_1['default'].debug('File uploaded: '.concat(link));
