      ...
      <Parallax ref={parallax} pages={3}>
        ...
        >
          <img
            ...
            alt="Golden State Bear Club Sample"
          />
        </ParallaxLayer>
        <ParallaxLayer
          offset={0.7}
          ...
          >
            ...
            <div className={"flex"}>
              <div className={"flex flex-col justify-center items-center"}>
                ...
                >
                  1. Donate money to help the adoption of children across the
                  world!
                </div>
                ...
                <div className={"text-3xl tracking-wide font-source mt-4"}>
                  4. Join a community of amazing individuals and help us build
