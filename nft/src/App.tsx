                    ...
                    >
                        ...
                        <div className={"flex"}>
                            <div className={"flex flex-col justify-center items-center"}>
                                <div className={"text-3xl font-source mt-4 tracking-wide font-source"}>
                                    1. Donate money to help the adoption of children across the world!
                                </div>
                                <div className={"text-3xl tracking-wide font-source mt-4"}>
                                    ...
                                    Pooh Bear community NFT token on the Solana blockchain!
                                </div>
                                <div className={"text-3xl tracking-wide font-source mt-4"}>
                                    3. Earn rewards with your NFTs at local stores and events!
                                </div>
                                <div className={"text-3xl tracking-wide font-source mt-4"}>
                                    4. Join a community of amazing individuals and help us build the future of adoption!
                                </div>
                            </div>
                            <Lottie
                                options={{
